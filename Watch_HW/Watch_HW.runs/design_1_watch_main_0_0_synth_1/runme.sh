...
HD_PWD='/home/lsh/2025/do it/watch/Watch_HW/Watch_HW.runs/design_1_watch_main_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_watch_main_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_watch_main_0_0.tcl
